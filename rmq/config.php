...
$query =   "CREATE TABLE IF NOT EXISTS Users(id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT, password TEXT); 
            ...
            CREATE TABLE IF NOT EXISTS user_reviews(id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER, review TEXT, movie_title TEXT, FOREIGN KEY(user_id) REFERENCES Users(id), FOREIGN KEY(movie_title) REFERENCES movies(title))";
